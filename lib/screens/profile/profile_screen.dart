...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _mostrarDialogoEdicion(String nombreActual, String telefonoActual) async {
    _nombreController.text = nombreActual == 'Usuario Nuevo' ? '' : nombreActual;
    _telefonoController.text = telefonoActual == 'Sin número' ? '' : telefonoActual;
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              }, SetOptions(merge: true)); // Merge asegura que no borremos otros campos como el 'role'
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: const Text('Cerrar Sesión', style: TextStyle(color: AppColors.lost, fontSize: 16, fontWeight: FontWeight.bold)),
